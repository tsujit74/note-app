...
export default function Signup() {
  ...
  const onSubmit = async (data: SignupForm) => {
    try {
      ...
      if (res.data?.userId) {
        ...
        addSuccess("OTP sent to your email. Please enter it below to continue.");
      } else {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white relative">
      ...
      <div className="flex w-full max-w-5xl h-[80vh] rounded-3xl shadow-2xl overflow-hidden">
        {/* Left Side */}
          ...
          <div className="w-full max-w-md">
            {step === "signup" && (
              <>
                ...
                <p className="text-gray-500 font-medium mb-8">Please enter your details to create an account.</p>
            ...
            {step === "otp" && (
              <>
                <h1 className="text-4xl font-bold text-gray-800 mb-2">Verify OTP</h1>
                <p className="text-gray-500 font-medium mb-8">Enter the OTP sent to your email to complete signup.</p>
        ...
        {/* Right Side Image */}
        <div className="flex-1 hidden md:flex items-center justify-center p-8 bg-gray-900 overflow-hidden">
          <div
            className="w-full h-full rounded-2xl bg-cover bg-center"
            style={{ backgroundImage: "url('https://placehold.co/1000x1000/000000/FFFFFF?text=Modern+Design')" }}
          />
        </div>
      </div>
    </div>
